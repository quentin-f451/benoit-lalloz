<div class="grid__image grid__image--<?= $mediaArray['orientation'] ?>">
	<?php if($mediaArray['status'] == 'listed') echo '<a href="' . $mediaArray["url"] . '">'; ?>
		<img class="thumb thumb--simple lazyload blur" 
            data-sizes="auto" 
            src="<?= $mediaArray['blurred'] ?>"
			data-srcset="<?= $mediaArray['srcXSmall'] ?> 400w, <?= $mediaArray['srcSmall'] ?> 750w, <?= $mediaArray['srcMedium'] ?> 1000w, <?= $mediaArray['srcLarge'] ?> 1720w, <?= $mediaArray['srcXLarge'] ?> 2560w"
